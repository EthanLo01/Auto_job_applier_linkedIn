...
search_terms = ["AI Software Engineer", "AI Software Developer", "Artificial Intelligence Engineer", "Data Scientist", "Quantitative Trader"]
...
location = ["New York", "Seattle", "California", ]                      # (dynamic multiple select)
